    ...
    <div class="section-container">
        ...
        <?php else: ?>
            <div class="blog-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: 40px;">
                ...
                <div class="blog-card animate-on-scroll" style="animation-delay: <?= $i * 0.05 ?>s; background: var(--glass-bg); border: 1px solid var(--glass-border); border-radius: 24px; overflow: hidden; backdrop-filter: blur(12px); transition: all 0.5s cubic-bezier(0.23, 1, 0.32, 1);">
                    
                    <div class="blog-media" style="position: relative; height: 240px; overflow: hidden; border-bottom: 1px solid var(--glass-border);">
                        ...
                        <div style="position:absolute; top:20px; right:20px; padding:6px 14px; background:var(--bg-primary); border:1px solid var(--glass-border); border-radius:10px; backdrop-filter:blur(8px); color:var(--text-primary); font-size:0.75rem; font-weight:600;">
                    ...
                    <div class="blog-content" style="padding: 30px;">
                        ...
                        <p style="color: var(--text-secondary); font-size: 0.95rem; line-height: 1.7; margin-bottom: 30px; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;"><?= e($blog['description'] ?? '') ?></p>
