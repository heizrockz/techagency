    ...
    <div class="footer-grid section-container">
        ...
        <div class="footer-col branding">
            ...
            <div class="footer-logo">
                <img src="<?= baseUrl($footerLogo) ?>" alt="<?= e($companyName) ?>" title="<?= e($companyName) ?>" style="max-height:30px;">
            ...
            <div class="footer-socials">
                ...
                <a href="<?= e($shareLinks['facebook']) ?>" target="_blank" rel="noopener noreferrer" aria-label="Share on Facebook">
                ...
                <a href="<?= e($shareLinks['twitter']) ?>" target="_blank" rel="noopener noreferrer" aria-label="Share on Twitter">
                ...
                <a href="<?= e($shareLinks['linkedin']) ?>" target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn">
                ...
                <a href="<?= e($shareLinks['whatsapp']) ?>" target="_blank" rel="noopener noreferrer" aria-label="Share on WhatsApp">
