    ...
    <div class="admin-main">
        <div class="admin-header">
            <div class="header-left">
                ...
                <p style="color: var(--text-muted); font-size: 0.85rem;">Configure SMTP and send bulk email campaigns.</p>
            </div>
        </div>

        <?php if ($saved): ?>
            <div class="alert alert-success" style="background:rgba(16,185,129,0.1); border:1px solid rgba(16,185,129,0.2); color:var(--neon-emerald); padding:15px; border-radius:10px; margin-bottom:20px;">Email settings saved successfully.</div>
        <?php endif; ?>

        <?php if ($sent): ?>
            <div class="alert alert-success" style="background:rgba(16,185,129,0.1); border:1px solid rgba(16,185,129,0.2); color:var(--neon-emerald); padding:15px; border-radius:10px; margin-bottom:20px;">Campaign executed. Emails are being sent. Check the history below.</div>
        <?php endif; ?>
            ...
            <div class="col-left">
                <div class="admin-card" style="margin-bottom: 30px;">
                    <div class="card-header" style="margin-bottom:20px;">
                        <h3 class="card-title" style="font-size:1.1rem; font-weight:600;">SMTP / IMAP Configuration</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div style="margin-top: 20px;">
                                <button type="submit" class="btn btn-primary" style="background:var(--theme-primary); border:none; padding:10px 20px; border-radius:8px; color:white; font-weight:600; cursor:pointer;">Save Configuration</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="margin-bottom:15px;">
                                ...
                                <textarea name="body" class="form-control" rows="10" required placeholder="Hello, we are excited to share..." style="width:100%; padding:10px; background:rgba(255,255,255,0.05); border:1px solid var(--glass-border); border-radius:8px; color:white; font-family:inherit;"></textarea>
                            </div>
                            <div class="form-group">
                                <label style="display:block; font-size:0.8rem; color:var(--text-muted); margin-bottom:5px;">Recipient List (CSV)</label>
                                <input type="file" name="email_list" class="form-control" accept=".csv" required style="width:100%; padding:8px; background:rgba(255,255,255,0.05); border:1px solid var(--glass-border); border-radius:8px; color:white;">
...
.btn-neon:hover {
    ...
    box-shadow: 0 5px 15px rgba(var(--neon-cyan-rgb), 0.3);
}
.admin-card {
